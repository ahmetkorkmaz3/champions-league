    ...
    <div class="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
        ...
        <div class="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                >
                    <h1 class="mb-1 font-medium">🏆 Champions League Simülasyonu</h1>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        4 takımlı lig simülasyonu ile Premier League kurallarına göre <br />maç sonuçlarını tahmin edin!
                    </p>
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            ...
                            <span>
                                <strong>6 Maç:</strong> Her takım diğer takımlarla bir kez karşılaşır
                            </span>
                        </li>
                        <li
                            class="relative flex items-center gap-4 py-2 before:absolute before:top-0 before:bottom-1/2 before:left-[0.4rem] before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]"
                        >
                            ...
                            <span>
                                <strong>Premier League Kuralları:</strong> Galibiyet 3, Beraberlik 1, Mağlubiyet 0 puan
                            </span>
                        </li>
                    </ul>
                ...
                >
                    <img src="https://a1.espncdn.com/combiner/i?img=%2Fi%2Fleaguelogos%2Fsoccer%2F500%2F23.png" alt="premier-league" />
                </div>
            </main>
        </div>
